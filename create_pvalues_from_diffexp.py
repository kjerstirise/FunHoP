...
def extract_pvalue():
	...
	diffexp_results = pd.read_table('/Users/profile/Documents/GitHub/cell-lines/celllines_only/pathway_analysis/diffexp_VCaPLNCaPvsRWPEPrEC_sep20.txt',
	...
	final_pvalues.to_csv('pvalues_TEST_diffexp_LNCaPVCaPvsRWPE_apr21.txt', header = True, index = None, sep = '\t', mode = 'w') 
